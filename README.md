...
Données sur les ventes : Informations sur la vente de robes

Données sur les caractéristiques et recommandations : Caractéristiques des robes avec étiquettes de recommandation (0 = non recommandé, 1 = recommandé)
...
Leçons apprises
L'importance d'un prétraitement rigoureux des données

La nécessité d'analyser les corrélations avant la modélisation

La valeur de l'expérimentation itérative avec différents algorithmes

Les limitations de l'approche sans code pour des problèmes complexes
...
Essais avec AutoML avec des ressources adéquates

Déploiement du modèle en production

Collecte de données supplémentaires pour améliorer la qualité des features
...
OpenClassrooms - Initiation au Machine Learning